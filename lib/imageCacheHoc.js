  ...
  return class extends React.PureComponent {
    ...
    render() {
      ...
      if (this.state.localFilePath) {
        ...
        if (this.state.localFilePath.indexOf("http") > -1) {
          localFileUri = this.state.localFilePath;
        } else {
          localFileUri = (Platform.OS == 'ios') ? this.state.localFilePath : 'file://' + this.state.localFilePath; // Android requires the traditional 3 prefixed slashes file:/// in a localhost absolute file uri.
        }
